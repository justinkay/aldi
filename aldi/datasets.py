...
# CFC
register_coco_instances("cfc_train", {"image_dir_prefix": "datasets/cfc/images/cfc_train", "translated_image_dir": f"datasets/daod-strong-baseline-cyclegan-results/cfc/test_1/images/fake_A"},         "datasets/cfc/coco_labels/cfc_train.json",                  "datasets/cfc/images/cfc_train/")
register_coco_instances("cfc_val",   {},         "datasets/cfc/coco_labels/cfc_val.json",                    "datasets/cfc/images/cfc_val/")
register_coco_instances("cfc_channel_train", {"image_dir_prefix": "datasets/cfc/images/cfc_channel_train", "translated_image_dir": f"datasets/daod-strong-baseline-cyclegan-results/cfc/test_1/images/fake_B"},         "datasets/cfc/coco_labels/cfc_channel_train.json",                  "datasets/cfc/images/cfc_channel_train/")
